...
for i=1:num_images%length(files)
    ...
    hh(:,:)=con_im(:,:).*ch_board(:,:);
    hh(:)=(hh(:)+1)/2;
    IM{i}=round(white*reshape(hh,resolution,1))';
end
clear hh con_im
clear picture
...
while time<t0+t_total-t_gray
    ...
    cgloadarray(11,1024,768,IM{img_counter},PalRGB,0);
    cgloadarray(12,1024,768,white-IM{img_counter},PalRGB,0);
...
cgnewpal;
sprite_size=20;
cgmakesprite(165,sprite_size,sprite_size,bgcol);
cgsetsprite(165);
cgpencol(bgcol);
...
cgmakesprite(166,sprite_size,sprite_size,bgcol);
cgsetsprite(166);
cgpencol(bgcol);
%cgellipse(0,0,30,30,'f');
cgpencol(white);
...
cgmakesprite(167,sprite_size,sprite_size,bgcol);
cgsetsprite(167);
cgpencol(bgcol);
%cgellipse(0,0,30,30,'f');
cgpencol(white);
...
cgmakesprite(168,sprite_size,sprite_size,bgcol);
cgsetsprite(168);
cgpencol(bgcol);
%cgellipse(0,0,30,30,'f');
cgpencol(white);
...
cgmakesprite(169,sprite_size,sprite_size,bgcol);
cgsetsprite(169);
cgpencol(bgcol);
%cgellipse(0,0,30,30,'f');
cgpencol(white);
