function circcheck_pal_run(subid,nrun,triggermode)
...
num_images=4;
luminance=0.9;
range=0.8; % used to set the nonlinearity and range of contrast
nonlin_con=2;
...
config_display( 0, 3, [0 0 0], [luminance luminance luminance], 'Arial', 24, 5 ,8)
%config_keyboard;
